...
class Account(Base):
    ...
    account_type: Mapped[AccountMainType] = mapped_column(
        Enum(
            AccountMainType,
            name="account_main_type",
            native_enum=False,
    ...
    dimension_rules: Mapped[list["AccountDimensionRule"]] = relationship(
